...
class ShopDropTest {
    ...
    public void whenDropFirst() {
        ...
        assertThat(rsl[0].getNameProduct()).isEqualTo("Bread");
    ...
    public void whenDropLast() {
        ...
        assertThat(rsl[0].getNameProduct()).isEqualTo("Milk");
        assertThat(rsl[1]).isNull();
    }
    ...
    public void whenArrayLengthIs4AndDeleteElementWithIndex1() {
        ...
        assertThat(rsl[index].getNameProduct()).isEqualTo("Milk");
        assertThat(rsl[2].getNameProduct()).isEqualTo("Fish");
    ...
    public void whenArrayLengthIs5AndDeleteElementWithIndex2() {
        ...
        int index = 2;
        Product[] rsl = ShopDrop.delete(products, index);
        assertThat(rsl[1].getNameProduct()).isEqualTo("Egg");
        assertThat(rsl[index].getNameProduct()).isEqualTo("Fish");
        assertThat(rsl[3].getNameProduct()).isEqualTo("Fruit");
        assertThat(rsl[products.length - 1]).isNull();
    }
}